...
public class Myclass {
	public static void main(String[] args) {
		List<Employee> asList = Arrays.asList(new Employee(1, "vivek", 20000, "devloper", 40),
				new Employee(2, "Rahul", 30000, "System engineer", 42), new Employee(3, "Adwait", 40000, "design", 50),
				new Employee(4, "sidhhu", 50000, "tester", 43), new Employee(1, "mahadev", 10000, "devloper", 42));
